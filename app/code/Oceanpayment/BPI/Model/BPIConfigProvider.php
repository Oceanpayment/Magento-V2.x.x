...
class BPIConfigProvider implements ConfigProviderInterface
{
    /**
    ...
    public function getConfig()
    {
        ...
        if ($this->methods[$code]->isAvailable($this->checkoutSession->getQuote())) {
            $config = [];
            $config['payment'] = [];
            $config['payment']['bpi']['redirectUrl'] = [];
            $config['payment']['bpi']['redirectUrl'][$code] = $this->getMethodRedirectUrl($code);
        }
