 ...
 */
namespace Oceanpayment\Union\Model;
...
class PaymentMethod extends AbstractMethod
{
    ...
    protected $_formBlockType = 'Oceanpayment\Union\Block\Form';
    protected $_infoBlockType = 'Oceanpayment\Union\Block\Info';
    ...
    {
        return $this->urlBuilder->getUrl('oceanpaymentunion/payment/redirect', ['_secure' => true]);
    }
    ...
    public function getCheckoutParameter()
    {
        ...
        //返回地址
        $backUrl           = $this->urlBuilder->getUrl('oceanpaymentunion/payment/back', ['_secure' => true,'_nosid' => true]);
        //服务器响应地址
        $noticeUrl         = $this->urlBuilder->getUrl('oceanpaymentunion/payment/notice', ['_secure' => true,'_nosid' => true]);
        //备注
