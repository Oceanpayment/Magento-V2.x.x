...
class OVOConfigProvider implements ConfigProviderInterface
{
    /**
    ...
    public function getConfig()
    {
        ...
        if ($this->methods[$code]->isAvailable($this->checkoutSession->getQuote())) {
            $config = [];
            $config['payment'] = [];
            $config['payment']['ovo']['redirectUrl'] = [];
            $config['payment']['ovo']['redirectUrl'][$code] = $this->getMethodRedirectUrl($code);
        }
