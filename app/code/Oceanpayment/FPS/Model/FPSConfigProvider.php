...
class FPSConfigProvider implements ConfigProviderInterface
{
    /**
    ...
    public function getConfig()
    {
        ...
        if ($this->methods[$code]->isAvailable($this->checkoutSession->getQuote())) {
            $config = [];
            $config['payment'] = [];
            $config['payment']['fps']['redirectUrl'] = [];
            $config['payment']['fps']['redirectUrl'][$code] = $this->getMethodRedirectUrl($code);
        }
