...
class Przelewy24ConfigProvider implements ConfigProviderInterface
{
    /**
    ...
    public function getConfig()
    {
        ...
        if ($this->methods[$code]->isAvailable($this->checkoutSession->getQuote())) {
            $config = [];
            $config['payment'] = [];
            $config['payment']['przelewy24']['redirectUrl'] = [];
            $config['payment']['przelewy24']['redirectUrl'][$code] = $this->getMethodRedirectUrl($code);
        }
